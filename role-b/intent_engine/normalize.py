...
from intent_engine.schemas import EventEntities, EventSignals, NormalizedEvent, PipelineWarning, RawEvent
...
def normalize_event(raw: RawEvent, ordinal: int) -> tuple[NormalizedEvent | None, PipelineWarning | None]:
    ...
    try:
        ...
        entities = _extract_entities(payload, family)
...
def _extract_entities(payload: dict[str, Any], family: str) -> EventEntities:
