...
const EVENT_ENDPOINT = process.env.INTENT_EVENT_ENDPOINT || "http://127.0.0.1:9477/v1/event";
const CONFIG_ENDPOINT = process.env.INTENT_CONFIG_ENDPOINT || "http://127.0.0.1:9477/v1/detailed-capture/config";
...
function createExtensionRuntime(vscode, options = {}) {
  ...
  function detailedCaptureEnabled(document) {
    return vscode.workspace.getConfiguration("intent", document.uri).get(DETAILED_CAPTURE_SETTING, false) === true;
  }
