...
| Firefox events missing | `about:policies` and `about:addons` | Confirm the signed Intent companion is installed and enabled. Existing managed Firefox policies are intentionally never overwritten. |
