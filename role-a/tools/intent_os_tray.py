...
LOCK_PATH = Path(os.environ.get("XDG_RUNTIME_DIR", "/tmp")) / "intent-os-tray.lock"
...
def main() -> int:
    ...
    indicator = AppIndicator.Indicator.new("intent-os", "dialog-information", AppIndicator.IndicatorCategory.APPLICATION_STATUS)
