(() => {
  ...
  function send(action, element, sensitive) {
    ...
    browser.runtime.sendMessage({
      ...
      payload: { action, sensitive_page: sensitive, target: describeTarget(element, sensitive) }
    }).catch(() => undefined);
  }
  ...
  function onClick(event) {
    ...
    send(element instanceof HTMLAnchorElement ? "link_activation" : "click", element, sensitive);
  }
