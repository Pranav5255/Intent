...
class IncrementalPageMeta(BaseModel):
    revision: int
    content_hash: str


class IncrementalEventsPage(BaseModel):
    version: int = 1
    date: str
    events: list[RawEvent]
    has_more: bool
    next_cursor: EventCursor | None = None
    page_meta: IncrementalPageMeta
...
class CopilotNotConfigured(BaseModel):
    ...
    message: str = (
        ...
        "ENGINE_LLM_ENABLED=true, and provider credentials "
